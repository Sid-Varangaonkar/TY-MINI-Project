...
def otp_gen(emailid):
    ...
    credentials=[{"id":"1032201708@mitwpu.edu.in","password":"sidd"},{"id":"1032201773@mitwpu.edu.in","password":"vaish"},{"id":"1032202184@mitwpu.edu.in","password":"yash",},{"id":"1032202163@mitwpu.edu.in","password":"anik"},{"id":"1032202200@mitwpu.edu.in","password":"birj"}]
...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "faceattendencerealtime-da7f8.appspot.com"
})
        ...
        if counter != 0:
            ...
            if modeType != 3:
                ...
                if counter <= 10:
                    ...
                    student_id=studentInfo['emailid']
